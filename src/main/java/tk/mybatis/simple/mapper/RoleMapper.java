...
public interface RoleMapper {
    ...
    @Results(
            ...
            @Result(property="roleName",column ="rele_name" ),
    ...
    @Update({
            "update sys_role set  role_name=#{roleName},enabled=#{enabled},create_by=#{createBy},create_time=#{createTime,jdbcType=TIMESTAMP} where id=#{id}"
    })
